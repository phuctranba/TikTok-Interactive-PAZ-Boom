var CZombies = function (b, a) {
    ...
    oDancingZombie = InheritO(OrnNoneZombies, {
        ...
        getShadow: function (a, bonusSpaceLeft = 0, bonusSpaceTop = 0) {
            return "left:" + (a.beAttackedPointL - 10 + bonusSpaceLeft) + "px;top:" + (a.height - 30 + bonusSpaceTop) + "px"
        },
        GetDX: function () {
            return -50
        },
            ...
            oSym.addTask(10, function (f, e) {
                ...
                g && g.beAttacked && (e.src = "images/Zombies/DancingZombie/Summon2.gif", oSym.addTask(10, function (t, s, x) {
                    ...
                    if (h && h.beAttacked) {
                        ...
                        while (r--) {
                            (q = m[r]) && (!(l = q[0]) || !$Z[l]) && (u[o] = (w[o] = new oBackupDancer).CustomBirth(q[1], q[2](v), 100, q[0] = "Z_" + Math.random()), n.push(NewImg("", k, "z-index:" + q[3] + ";left:" + q[4](v) + "px;top:" + q[5] + "px", EDAll)), ++o)
                        }
        ...
        NormalAttack: function (d, b) {
            ...
            oSym.addTask(100, function (m, j, i, l, n) {
                ...
                h && ((k = $P[j]) && k.Stature > 0 ? (h.AttackedRX = (h.X = (h.AttackedLX = h.ZX = q = k.AttackedRX) - h.beAttackedPointL) + h.beAttackedPointR, SetStyle(i, {
                    ...
                    var u = $Z[s],
                        t;
                    u && (v.src = "images/Zombies/PoleVaultingZombie/PoleVaultingZombieWalk.gif", u.isAttacking = 0, u.Altitude = 1, u.OSpeed = u.Speed = 1, u.NormalGif = 9, u.LostHeadGif = 10, u.NormalAttack = (t = CZombies.prototype).NormalAttack, u.getFreeze = t.getFreeze, u.getRaven = t.getRaven)
                }, [m, n])))
            }, [d, b, a, c, e])
        }
    }),
    ...
    oNewspaperZombie = InheritO(OrnIIZombies, {
        ...
        getShadow: function (a, bonusSpaceLeft = 0, bonusSpaceTop = 0) {
            return "left:75px;top:" + (a.height - 25+bonusSpaceTop) + "px"
        },
        GoingDie: function (b) {
            var a = this,
                c = a.id;
    ...
    oDuckyTubeZombie1 = InheritO(oAquaticZombie, {
        ...
        PicArr: (function () {
            ...
            return ["images/Card/Zombies/DuckyTubeZombie1.png", "images/Card/Zombies/DuckyTubeZombie1G.png", a + "Walk1.gif", a + "Walk2.gif", a + "1.gif", a + "Attack.gif", "images/Zombies/Zombie/ZombieHead.gif" + $Random, a + "Die.gif" + $Random, a + "BoomDie.gif" + $Random]
        })(),
        GoingDie: function () {
            var b = this,
                c = b.id,
    ...
    oDuckyTubeZombie2 = InheritO(oDuckyTubeZombie1, {
        ...
        PicArr: (function () {
            ...
            return ["images/Card/Zombies/DuckyTubeZombie1.png", "images/Card/Zombies/DuckyTubeZombie1G.png", b + "Walk1.gif", b + "Walk2.gif", b + "1.gif", b + "Attack.gif", "images/Zombies/Zombie/ZombieHead.gif" + $Random, a + "Die.gif" + $Random, a + "Walk1.gif", a + "Walk2.gif", a + "Attack.gif", a + "BoomDie.gif" + $Random]
        })(),
        getHurt: function (i, a, g, m, c, k, j) {
            var e = this;
            if (!e.beAttacked) {
    ...
    oSnorkelZombie = InheritO(oDuckyTubeZombie1, {
        ...
        getShadow: function (a, bonusSpaceLeft = 0, bonusSpaceTop = 0) {
            return "left:" + (a.beAttackedPointL+bonusSpaceLeft) + "px;top:" + (a.height - 45+bonusSpaceTop) + "px"
        },
        PicArr: (function () {
            var a = "images/Zombies/SnorkelZombie/";
            return ["images/Card/Zombies/SnorkelZombie.png", "images/Card/Zombies/SnorkelZombieG.png", a + "Walk1.gif", a + "Walk2.gif", a + "1.gif", a + "Attack.gif", a + "Head.gif" + $Random, a + "Die.gif" + $Random, a + "Jump.gif" + $Random, a + "Risk.gif" + $Random, a + "Sink.gif" + $Random, a + "BoomDie.gif" + $Random]
        }()),
